 ...
 * boards through serial communication.
 * 
...
public class Arduino implements Device {
    ...
    /**
     * Notifies the device about an action to be executed.
     * Receives data from the connection and maps it to an action if available.
     */
    @Override
    public void notifyAction() {
        this.connection.receive()
                .flatMap(this.configuration::action)
                .ifPresent(Action::doAction);
    }
